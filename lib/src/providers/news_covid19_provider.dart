...
final newsCOVID19Provider = FutureProvider.autoDispose<List<Article>>((ref) async {
  ref.maintainState = true;
  final newsService = ref.read(newsServiceProvider);

  final articles = newsService.getArticles(
    path: 'https://newsapi.org/v2/top-headlines?q=coronavirus&language=en&apiKey=${_environmentConfig.newsApiKey}',
  );
  return articles;
});
