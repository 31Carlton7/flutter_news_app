// Place fonts/canton_icons_line.ttf in your fonts/ directory and
// add the following to your pubspec.yaml
// flutter:
//   fonts:
//    - family: canton_icons_line
//      fonts:
//       - asset: fonts/canton_icons_line.ttf
import 'package:flutter/widgets.dart';

class Canton_icons_line {
  Canton_icons_line._();

  static const String _fontFamily = 'canton_icons_line';

  static const IconData Users_1 = IconData(0xe900, fontFamily: _fontFamily);
  static const IconData Users_2 = IconData(0xe901, fontFamily: _fontFamily);
  ...
  static const IconData Arrow_Down_2 = IconData(0xe904, fontFamily: _fontFamily);
  static const IconData Arrow_Down_3 = IconData(0xe905, fontFamily: _fontFamily);
  static const IconData Arrow_Down_Circle = IconData(0xe906, fontFamily: _fontFamily);
  static const IconData Arrow_Down_Square = IconData(0xe907, fontFamily: _fontFamily);
  static const IconData Arrow_Down = IconData(0xe908, fontFamily: _fontFamily);
  static const IconData Arrow_Left_2 = IconData(0xe909, fontFamily: _fontFamily);
  static const IconData Arrow_Left_3 = IconData(0xe90a, fontFamily: _fontFamily);
  static const IconData Arrow_Left_Circle = IconData(0xe90b, fontFamily: _fontFamily);
  static const IconData Arrow_Left_Square = IconData(0xe90c, fontFamily: _fontFamily);
  static const IconData Arrow_Left = IconData(0xe90d, fontFamily: _fontFamily);
  static const IconData Arrow_Right_2 = IconData(0xe90e, fontFamily: _fontFamily);
  static const IconData Arrow_Right_3 = IconData(0xe90f, fontFamily: _fontFamily);
  static const IconData Arrow_Right_Circle = IconData(0xe910, fontFamily: _fontFamily);
  static const IconData Arrow_Right_Square = IconData(0xe911, fontFamily: _fontFamily);
  static const IconData Arrow_Right = IconData(0xe912, fontFamily: _fontFamily);
  static const IconData Arrow_Up_2 = IconData(0xe913, fontFamily: _fontFamily);
  static const IconData Arrow_Up_3 = IconData(0xe914, fontFamily: _fontFamily);
  static const IconData Arrow_Up_Circle = IconData(0xe915, fontFamily: _fontFamily);
  static const IconData Arrow_Up_Square = IconData(0xe916, fontFamily: _fontFamily);
